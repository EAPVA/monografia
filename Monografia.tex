...
\hyphenation{mo-de-lar re-no-vá-veis re-pre-sen-tar re-pre-sen-ta-ção
  la-te-rais res-pec-ti-vos re-a-ção re-a-li-zan-do o-pe-ra-ções cons-tan-te
    di-fe-ren-tes tem-pe-ra-tu-ra ex-tre-mi-da-de ter-mo-di-nâ-mi-ca
    trans-es-te-ri-fi-ca-ção In-ter-net com-pu-ta-cio-nal}
...
\input{plano/0_preambulo.tex}
\input{plano/1_introducao.tex}
\input{plano/2_levantamento.tex}
\input{plano/3_algoritmos.tex}
\input{plano/4_recursos.tex}
\input{plano/5_desenvolvimento.tex}
\input{plano/5_1_hoggpu.tex}
\input{plano/6_testes.tex}
%\input{plano/7_gestao.tex}
\input{plano/8_conclusao.tex}
\input{plano/9_referencias.tex}
