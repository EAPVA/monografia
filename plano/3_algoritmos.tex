...
Neste capítulo são primeiramente definidos alguns conceitos e definições
referentes a imagens. Em seguida é apresentado brevemente o conceito de
gradiente de imagem. 
...
e o contra-domínio será normalizado para a faixa \([0,1]\). Em 
\ref{eq:image_dominio} é apresentada a definição do domínio da função I. 
