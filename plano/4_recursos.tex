...
memória é grande o suficiente para nos permitir trabalhar com imagem e vídeo. Em
adição, a placa também possui uma saída HDMI permitindo que pudessemos testar
nosso software com vídeos e imagens de alta resolução.
...
framework, multiplas threads por core, escalonamento pela API, warp, thread
ID/block ID
