...
TODO: Separar os objetivos, colocar metas e ações para cada um
...
No capítulo 2 será apresentado um breve levantamento de trabalhos relacionados
a reconhecimento automático de placas, reconhecimento de texto e uso de GPU
para extração de características.

No capítulo 3 são descritos os principais algoritmos relevantes ao trabalho, o
cálculo de gradientes, o descritor HOG e o descritor T-HOG.

No capítulo 4 encontram-se informações sobre os recursos de hardware e software
utilizados.

No capítulo 5 tem-se o relatório do trabalho desenvolvido.

O capítulo 6 relata os resultados dos testes.

O capítulo 7 trata da gestão do projeto. Contém o número de horas trabalhadas, a
análise de riscos e algumas considerações da equipe sobre o projeto.

No capítulo 8 se colocam considerações finais sobre os resultados e indicações
